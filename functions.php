...
function picard_scripts() {
	...
	wp_register_script( 'picard-react', get_template_directory_uri() . '/libs/react.js', '20141119', true );
	wp_register_script( 'picard-jsx', get_template_directory_uri() . '/libs/jsx.js', '20141119', true );
